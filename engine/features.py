...
def openCommand(query):
    query = query.replace(OLLAMA_MODEL, "")
...
def findContact(query):
    ...
    words_to_remove = [OLLAMA_MODEL, 'make', 'a', 'to', 'phone', 'call', 'send', 'message', 'wahtsapp', 'video']
...
def chatBot(query):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            speak("I couldn’t get a response from Ollama.")
            return "Error from Ollama"
    except Exception as e:
        print(" Failed to connect to Ollama:", e)
        speak("I'm having trouble connecting to Ollama.")
